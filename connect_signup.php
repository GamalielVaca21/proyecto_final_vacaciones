...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $insertSql = "INSERT INTO usuario (turno, numero_reloj, nombre, fecha_ingreso, antigüedad, puesto, area, fecha_nacimiento, edad, numero_telefono, tipo_usuario)
                      VALUES ('$turno', '$numero_reloj', '$nombre', '$fecha_ingreso', '$antigüedad', '$puesto', '$area', '$fecha_nacimiento', '$edad', '$numero_telefono', 'user')";
